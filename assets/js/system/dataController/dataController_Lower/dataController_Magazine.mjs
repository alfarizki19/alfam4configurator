...
{ const b1=document.getElementById("buttonItemsID_Magazine00100101"); if(b1) b1.addEventListener("click", function(){ uiReset_magazine001001(); uiReset_magazine002001(); window.part.magazine["001"].products["001"].variants["01"].quantity=1; uiData_Magazine(); }); const b2=document.getElementById("buttonItemsID_Magazine00200101"); if(b2) b2.addEventListener("click", function(){ uiReset_magazine001001(); uiReset_magazine002001(); window.part.magazine["002"].products["001"].variants["01"].quantity=1; uiData_Magazine(); }); }
